...
const file_user_user_proto_rawDesc = "" +
	...
	"\x04city\x18\x04 \x01(\tR\x04city\"\xa1\x02\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x19\n" +
	"\x03age\x18\x03 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x03age\x12(\n" +
	"\abalance\x18\x04 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\abalance\x12\x1b\n" +
	"\tis_active\x18\x05 \x01(\bR\bisActive\x12'\n" +
	"\aaddress\x18\x06 \x01(\v2\r.user.AddressR\aaddress\x12\x1c\n" +
	"\teducation\x18\a \x03(\tR\teducation\x12\x1f\n" +
